(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    PaginatorIntlExample.ɵcmp = /*@__PURE__*/ i0__namespace.ɵɵdefineComponent({ type: PaginatorIntlExample, selectors: [["paginator-intl-example"]], decls: 1, vars: 3, consts: [[3, "length", "pageSizeOptions"]], template: function PaginatorIntlExample_Template(rf, ctx) {
            if (rf & 1) {
                i0__namespace.ɵɵelement(0, "mat-paginator", 0);
            }
            if (rf & 2) {
