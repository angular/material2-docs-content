    ...
    ***************************************************************************** */
    ...
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0__namespace.ɵsetClassMetadata(MyTelInput, [{
                type: i0.Component,
                args: [{ selector: 'example-tel-input', providers: [{ provide: i1.MatFormFieldControl, useExisting: MyTelInput }], host: {
    ...
    FormFieldHarnessExample.ɵcmp = /*@__PURE__*/ i0__namespace.ɵɵdefineComponent({ type: FormFieldHarnessExample, selectors: [["form-field-harness-example"]], decls: 8, vars: 1, consts: [["id", "with-errors", "appearance", "fill"], [1, "custom-control"], ["matInput", "", 3, "formControl"], ["align", "start"]], template: function FormFieldHarnessExample_Template(rf, ctx) {
            if (rf & 1) {
                i0__namespace.ɵɵelementStart(0, "mat-form-field", 0);
    ...
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0__namespace.ɵsetClassMetadata(FormFieldExamplesModule, [{
                ...
                args: [{
                        ...
                        declarations: __spreadArray(__spreadArray([], __read(EXAMPLES), false), [MyTelInput], false),
                        exports: EXAMPLES,
