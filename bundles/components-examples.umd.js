(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@angular/components-examples', ['exports', 'tslib'], factory) :
    (global = global || self, factory((global.ng = global.ng || {}, global.ng.componentsExamples = {}), global.tslib));
    ...
    var ExampleData = /** @class */ (function () {
        function ExampleData(example) {
            ...
            (_a = this.exampleFiles).push.apply(_a, tslib.__spread(additionalFiles));
            this.description = title || exampleName.replace(/[\-]+/g, ' ') + ' Example';
            this.componentNames = tslib.__spread([componentName], additionalComponents);
        }
        return ExampleData;
    }());
