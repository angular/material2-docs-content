(function (global, factory) {
    ...
    var _c0 = ["fruitInput"];
    function ChipsAutocompleteExample_mat_chip_5_button_2_Template(rf, ctx) {
        if (rf & 1) {
            i0__namespace.ɵɵelementStart(0, "button", 11);
            i0__namespace.ɵɵelementStart(1, "mat-icon");
            i0__namespace.ɵɵtext(2, "cancel");
    ...
    function ChipsAutocompleteExample_mat_chip_5_Template(rf, ctx) {
        if (rf & 1) {
            ...
            i0__namespace.ɵɵtemplate(2, ChipsAutocompleteExample_mat_chip_5_button_2_Template, 3, 0, "button", 10);
            i0__namespace.ɵɵelementEnd();
        }
        if (rf & 2) {
    ...
    ChipsAutocompleteExample.ɵcmp = /*@__PURE__*/ i0__namespace.ɵɵdefineComponent({ type: ChipsAutocompleteExample, selectors: [["chips-autocomplete-example"]], viewQuery: function ChipsAutocompleteExample_Query(rf, ctx) {
        ...
        }, directives: [i1__namespace.MatFormField, i1__namespace.MatLabel, i1__namespace$1.MatChipList, i3__namespace.NgForOf, i4__namespace.DefaultValueAccessor, i5__namespace.MatAutocompleteTrigger, i1__namespace$1.MatChipInput, i4__namespace.NgControlStatus, i4__namespace.FormControlDirective, i5__namespace.MatAutocomplete, i1__namespace$1.MatChip, i3__namespace.NgIf, i1__namespace$1.MatChipRemove, i6__namespace.MatIcon, i7__namespace.MatOption], pipes: [i3__namespace.AsyncPipe], styles: [".example-chip-list[_ngcontent-%COMP%] {\n  width: 100%;\n}"] });
    (function () {
    ...
    function ChipsInputExample_mat_chip_5_button_2_Template(rf, ctx) {
        if (rf & 1) {
    ...
    function ChipsInputExample_mat_chip_5_Template(rf, ctx) {
        if (rf & 1) {
            ...
            i0__namespace.ɵɵtext(1);
            i0__namespace.ɵɵtemplate(2, ChipsInputExample_mat_chip_5_button_2_Template, 3, 0, "button", 6);
            i0__namespace.ɵɵelementEnd();
        }
        if (rf & 2) {
    ...
    ChipsInputExample.ɵcmp = /*@__PURE__*/ i0__namespace.ɵɵdefineComponent({ type: ChipsInputExample, selectors: [["chips-input-example"]], decls: 7, vars: 4, consts: [["appearance", "fill", 1, "example-chip-list"], ["aria-label", "Fruit selection"], ["chipList", ""], [3, "selectable", "removable", "removed", 4, "ngFor", "ngForOf"], ["placeholder", "New fruit...", 3, "matChipInputFor", "matChipInputSeparatorKeyCodes", "matChipInputAddOnBlur", "matChipInputTokenEnd"], [3, "selectable", "removable", "removed"], ["matChipRemove", "", 4, "ngIf"], ["matChipRemove", ""]], template: function ChipsInputExample_Template(rf, ctx) {
            if (rf & 1) {
                i0__namespace.ɵɵelementStart(0, "mat-form-field", 0);
                i0__namespace.ɵɵelementStart(1, "mat-label");
                i0__namespace.ɵɵtext(2, "Favorite Fruits");
        ...
        }, directives: [i1__namespace.MatFormField, i1__namespace.MatLabel, i1__namespace$1.MatChipList, i3__namespace.NgForOf, i1__namespace$1.MatChipInput, i1__namespace$1.MatChip, i3__namespace.NgIf, i1__namespace$1.MatChipRemove, i6__namespace.MatIcon], styles: [".example-chip-list[_ngcontent-%COMP%] {\n  width: 100%;\n}"] });
    (function () {
    ...
    function ChipsFormControlExample_mat_chip_15_Template(rf, ctx) {
        if (rf & 1) {
            var _r4_1 = i0__namespace.ɵɵgetCurrentView();
            i0__namespace.ɵɵelementStart(0, "mat-chip", 7);
            i0__namespace.ɵɵlistener("removed", function ChipsFormControlExample_mat_chip_15_Template_mat_chip_removed_0_listener() { var restoredCtx = i0__namespace.ɵɵrestoreView(_r4_1); var keyword_r2 = restoredCtx.$implicit; var ctx_r3 = i0__namespace.ɵɵnextContext(); return ctx_r3.removeKeyword(keyword_r2); });
            i0__namespace.ɵɵtext(1);
            i0__namespace.ɵɵelementEnd();
        }
        if (rf & 2) {
            var keyword_r2 = ctx.$implicit;
            i0__namespace.ɵɵproperty("selected", keyword_r2)("value", keyword_r2);
            i0__namespace.ɵɵadvance(1);
    ...
    var ChipsFormControlExample = /** @class */ (function () {
        function ChipsFormControlExample() {
            ...
            this.formControl = new i4.FormControl(['angular']);
        }
    ...
    ChipsFormControlExample.ɵcmp = /*@__PURE__*/ i0__namespace.ɵɵdefineComponent({ type: ChipsFormControlExample, selectors: [["chips-form-control-example"]], decls: 21, vars: 4, consts: [[1, "example-button-container"], ["mat-raised-button", "", 3, "click"], ["appearance", "fill", 1, "example-chip-list"], ["aria-label", "Video keywords", "multiple", "", 3, "formControl"], ["chipList", ""], [3, "selected", "value", "removed", 4, "ngFor", "ngForOf"], ["placeholder", "New keyword...", 3, "matChipInputFor", "matChipInputTokenEnd"], [3, "selected", "value", "removed"]], template: function ChipsFormControlExample_Template(rf, ctx) {
            if (rf & 1) {
                ...
                i0__namespace.ɵɵelementStart(6, "i");
                i0__namespace.ɵɵtext(7, "Select a focused chip by pressing ");
                i0__namespace.ɵɵelementStart(8, "code");
                i0__namespace.ɵɵtext(9, "SPACE");
                i0__namespace.ɵɵelementEnd();
                i0__namespace.ɵɵelementEnd();
                i0__namespace.ɵɵelementEnd();
                i0__namespace.ɵɵelementStart(10, "mat-form-field", 2);
                i0__namespace.ɵɵelementStart(11, "mat-label");
                i0__namespace.ɵɵtext(12, "Video keywords");
                i0__namespace.ɵɵelementEnd();
                i0__namespace.ɵɵelementStart(13, "mat-chip-list", 3, 4);
                i0__namespace.ɵɵtemplate(15, ChipsFormControlExample_mat_chip_15_Template, 2, 3, "mat-chip", 5);
                i0__namespace.ɵɵelementStart(16, "input", 6);
                i0__namespace.ɵɵlistener("matChipInputTokenEnd", function ChipsFormControlExample_Template_input_matChipInputTokenEnd_16_listener($event) { return ctx.addKeywordFromInput($event); });
                i0__namespace.ɵɵelementEnd();
                i0__namespace.ɵɵelementEnd();
                i0__namespace.ɵɵelementEnd();
                i0__namespace.ɵɵelementStart(17, "p");
                i0__namespace.ɵɵelementStart(18, "b");
                i0__namespace.ɵɵtext(19, "The following keywords are selected:");
                i0__namespace.ɵɵelementEnd();
                i0__namespace.ɵɵtext(20);
                i0__namespace.ɵɵelementEnd();
            }
            if (rf & 2) {
                var _r0 = i0__namespace.ɵɵreference(14);
                ...
                i0__namespace.ɵɵadvance(4);
                i0__namespace.ɵɵtextInterpolate1(" ", ctx.formControl.value, "\n");
            }
