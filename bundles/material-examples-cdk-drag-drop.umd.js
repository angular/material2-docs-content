(function (global, factory) {
    ...
    var CdkDragDropAxisLockExample = /** @class */ (function () {
        ...
        CdkDragDropAxisLockExample.ngComponentDef = i0.ɵɵdefineComponent({ type: CdkDragDropAxisLockExample, selectors: [["cdk-drag-drop-axis-lock-example"]], decls: 4, vars: 0, consts: [["cdkDragLockAxis", "y", "cdkDrag", "", 1, "example-box"], ["cdkDragLockAxis", "x", "cdkDrag", "", 1, "example-box"]], template: function CdkDragDropAxisLockExample_Template(rf, ctx) { if (rf & 1) {
    ...
    var CdkDragDropBoundaryExample = /** @class */ (function () {
        ...
        CdkDragDropBoundaryExample.ngComponentDef = i0.ɵɵdefineComponent({ type: CdkDragDropBoundaryExample, selectors: [["cdk-drag-drop-boundary-example"]], decls: 3, vars: 0, consts: [[1, "example-boundary"], ["cdkDragBoundary", ".example-boundary", "cdkDrag", "", 1, "example-box"]], template: function CdkDragDropBoundaryExample_Template(rf, ctx) { if (rf & 1) {
                i0.ɵɵelementStart(0, "div", 0);
    ...
    var CdkDragDropDelayExample = /** @class */ (function () {
        ...
        CdkDragDropDelayExample.ngComponentDef = i0.ɵɵdefineComponent({ type: CdkDragDropDelayExample, selectors: [["cdk-drag-drop-delay-example"]], decls: 2, vars: 1, consts: [["cdkDrag", "", 1, "example-box", 3, "cdkDragStartDelay"]], template: function CdkDragDropDelayExample_Template(rf, ctx) { if (rf & 1) {
                i0.ɵɵelementStart(0, "div", 0);
    ...
    var CdkDragDropFreeDragPositionExample = /** @class */ (function () {
        ...
        CdkDragDropFreeDragPositionExample.ngComponentDef = i0.ɵɵdefineComponent({ type: CdkDragDropFreeDragPositionExample, selectors: [["cdk-drag-drop-free-drag-position-example"]], decls: 5, vars: 1, consts: [[3, "click"], ["cdkDrag", "", 1, "example-box", 3, "cdkDragFreeDragPosition"]], template: function CdkDragDropFreeDragPositionExample_Template(rf, ctx) { if (rf & 1) {
    ...
    var CdkDragDropRootElementExample = /** @class */ (function () {
        ...
        CdkDragDropRootElementExample.propDecorators = {
            _dialogTemplate: [{ type: i0.ViewChild, args: [i0.TemplateRef, { static: false },] }]
        };
        CdkDragDropRootElementExample.ngFactoryDef = function CdkDragDropRootElementExample_Factory(t) { return new (t || CdkDragDropRootElementExample)(i0.ɵɵdirectiveInject(i1$1.Overlay), i0.ɵɵdirectiveInject(i0.ViewContainerRef)); };
    ...
    var CdkDragDropSortingExample = /** @class */ (function () {
        ...
        CdkDragDropSortingExample.ngComponentDef = i0.ɵɵdefineComponent({ type: CdkDragDropSortingExample, selectors: [["cdk-drag-drop-sorting-example"]], decls: 2, vars: 1, consts: [["cdkDropList", "", 1, "example-list", 3, "cdkDropListDropped"], ["class", "example-box", "cdkDrag", "", 4, "ngFor", "ngForOf"], ["cdkDrag", "", 1, "example-box"]], template: function CdkDragDropSortingExample_Template(rf, ctx) { if (rf & 1) {
                i0.ɵɵelementStart(0, "div", 0);
