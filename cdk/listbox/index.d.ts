...
export declare class CdkListboxActivedescendantExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxActivedescendantExample, "cdk-listbox-activedescendant-example", ["cdkListboxActivedescendantExample"], {}, {}, never, never, false>;
}
...
export declare class CdkListboxCompareWithExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxCompareWithExample, "cdk-listbox-compare-with-example", ["cdkListboxCompareWithExample"], {}, {}, never, never, false>;
}
...
export declare class CdkListboxCustomNavigationExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxCustomNavigationExample, "cdk-listbox-custom-navigation-example", ["cdkListboxCustomNavigationExample"], {}, {}, never, never, false>;
}
...
export declare class CdkListboxCustomTypeaheadExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxCustomTypeaheadExample, "cdk-listbox-custom-typeahead-example", ["cdkListboxCustomTypeaheadExample"], {}, {}, never, never, false>;
}
...
export declare class CdkListboxDisabledExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxDisabledExample, "cdk-listbox-disabled-example", ["cdkListboxDisabledExample"], {}, {}, never, never, false>;
}
...
export declare class CdkListboxFormsValidationExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxFormsValidationExample, "cdk-listbox-forms-validation-example", ["cdkListboxFormsValidationExample"], {}, {}, never, never, false>;
}
...
export declare class CdkListboxHorizontalExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxHorizontalExample, "cdk-listbox-horizontal-example", ["cdkListboxhorizontalExample"], {}, {}, never, never, false>;
}
...
export declare class CdkListboxMultipleExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxMultipleExample, "cdk-listbox-multiple-example", ["cdkListboxMultipleExample"], {}, {}, never, never, false>;
}

/** @title Basic listbox. */
export declare class CdkListboxOverviewExample {
    static ɵfac: i0.ɵɵFactoryDeclaration<CdkListboxOverviewExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxOverviewExample, "cdk-listbox-overview-example", ["cdkListboxOverviewExample"], {}, {}, never, never, false>;
}
...
export declare class CdkListboxReactiveFormsExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxReactiveFormsExample, "cdk-listbox-reactive-forms-example", ["cdkListboxReactiveFormsExample"], {}, {}, never, never, false>;
}
...
export declare class CdkListboxTemplateFormsExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxTemplateFormsExample, "cdk-listbox-template-forms-example", ["cdkListboxTemplateFormsExample"], {}, {}, never, never, false>;
}
...
export declare class CdkListboxValueBindingExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkListboxValueBindingExample, "cdk-listbox-value-binding-example", ["cdkListboxValueBindingExample"], {}, {}, never, never, false>;
}
