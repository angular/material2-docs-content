...
declare class CdkMenuStandaloneMenuExample {
    static ɵfac: i0.ɵɵFactoryDeclaration<CdkMenuStandaloneMenuExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkMenuStandaloneMenuExample, "cdk-menu-standalone-menu-example", never, {}, {}, never, never, true, never>;
}

/** @title Stateful Menu with Standalone Trigger. */
declare class CdkMenuStandaloneStatefulMenuExample {
    bold: boolean;
    italic: boolean;
    sizes: string[];
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CdkMenuStandaloneStatefulMenuExample, "cdk-menu-standalone-stateful-menu-example", never, {}, {}, never, never, true, never>;
}
