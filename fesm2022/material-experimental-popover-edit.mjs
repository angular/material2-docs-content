...
class PopoverEditMatTableFlexExample {
    ...
    preservedNameValues = new WeakMap();
    preservedWeightValues = new WeakMap();
...
class PopoverEditMatTableExample {
    ...
    nameValues = new FormValueContainer();
    weightValues = new FormValueContainer();
    typeValues = new FormValueContainer();
    fantasyValues = new FormValueContainer();
    onSubmitName(element, f) {
        if (!f.valid) {
            return;
        }
...
//# sourceMappingURL=material-experimental-popover-edit.mjs.map
