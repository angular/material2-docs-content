...
import { viewChildren, computed, Component } from '@angular/core';
...
import { AccordionTrigger, AccordionGroup, AccordionPanel, AccordionContent } from '@angular/aria/accordion';
...
class AccordionConfigurableExample {
  ...
  triggers = viewChildren(AccordionTrigger, ...(ngDevMode ? [{
    debugName: "triggers"
  }] : []));
  expandedIds = computed(() => this.triggers().filter(t => t.expanded()).map(t => t.panelId()), ...(ngDevMode ? [{
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      inputs: ["id", "panelId", "disabled", "expanded"],
