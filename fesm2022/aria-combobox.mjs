...
class ComboboxManualExample {
    ...
    options = computed(() => states$3.filter(state => state.toLowerCase().startsWith(this.searchString().toLowerCase())), ...(ngDevMode ? [{ debugName: "options" }] : []));
    constructor() {
        afterRenderEffect(() => {
...
class ComboboxReadonlyExample {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: i0, type: ComboboxReadonlyExample, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.2.0-next.2", type: ComboboxReadonlyExample, isStandalone: true, selector: "combobox-readonly-example", viewQueries: [{ propertyName: "popover", first: true, predicate: ["popover"], descendants: true, isSignal: true }, { propertyName: "listbox", first: true, predicate: Listbox, descendants: true, isSignal: true }, { propertyName: "combobox", first: true, predicate: Combobox, descendants: true, isSignal: true }], ngImport: i0, template: "<div ngCombobox #combobox=\"ngCombobox\" class=\"example-combobox-container\" [readonly]=\"true\">\n  <div class=\"example-combobox-input-container\">\n    <input\n      ngComboboxInput\n      class=\"example-combobox-input\"\n      placeholder=\"Search...\"\n      [(value)]=\"searchString\"\n    />\n    <span class=\"material-symbols-outlined example-icon example-arrow-icon\">arrow_drop_down</span>\n  </div>\n\n  <div popover=\"manual\" #popover class=\"example-popover\">\n    <ng-template ngComboboxPopupContainer>\n      <div ngListbox class=\"example-listbox\">\n        @for (option of options(); track option) {\n          <div\n            class=\"example-option example-selectable example-stateful\"\n            ngOption\n            [value]=\"option\"\n            [label]=\"option\"\n          >\n            <span>{{option}}</span>\n            <span\n              aria-hidden=\"true\"\n              class=\"material-symbols-outlined example-icon example-selected-icon\"\n              >check</span\n            >\n          </div>\n        }\n      </div>\n    </ng-template>\n  </div>\n</div>\n", styles: [".example-combobox-container {\n  position: relative;\n  width: 300px;\n  display: flex;\n  flex-direction: column;\n  border: 1px solid var(--mat-sys-outline);\n  border-radius: var(--mat-sys-corner-extra-small);\n}\n\n.example-combobox-input-container {\n  display: flex;\n  position: relative;\n  align-items: center;\n  border-radius: var(--mat-sys-corner-extra-small);\n}\n\n.example-combobox-input {\n  border-radius: var(--mat-sys-corner-extra-small);\n}\n\n.example-combobox-input[readonly='true'] {\n  cursor: pointer;\n  padding: 0.7rem 1rem;\n}\n\n.example-combobox-container:focus-within .example-combobox-input {\n  outline: 1.5px solid var(--mat-sys-primary);\n  box-shadow: 0 0 0 4px color-mix(in srgb, var(--mat-sys-primary) 25%, transparent);\n}\n\n.example-icon {\n  width: 24px;\n  height: 24px;\n  font-size: 20px;\n  display: grid;\n  place-items: center;\n  pointer-events: none;\n}\n\n.example-search-icon {\n  padding: 0 0.5rem;\n  position: absolute;\n  opacity: 0.8;\n}\n\n.example-arrow-icon {\n  padding: 0 0.5rem;\n  position: absolute;\n  right: 0;\n  opacity: 0.8;\n  transition: transform 0.2s ease;\n}\n\n.example-combobox-input[aria-expanded='true'] + .example-arrow-icon {\n  transform: rotate(180deg);\n}\n\n.example-combobox-input {\n  width: 100%;\n  border: none;\n  outline: none;\n  font-size: 1rem;\n  padding: 0.7rem 1rem 0.7rem 2.5rem;\n  background-color: var(--mat-sys-surface);\n}\n\n.example-popover {\n  margin: 0;\n  padding: 0;\n  border: 1px solid var(--mat-sys-outline);\n  border-radius: var(--mat-sys-corner-extra-small);\n  background-color: var(--mat-sys-surface);\n}\n\n.example-listbox {\n  display: flex;\n  flex-direction: column;\n  overflow: auto;\n  max-height: 10rem;\n  padding: 0.5rem;\n}\n\n.example-option {\n  cursor: pointer;\n  padding: 0.3rem 1rem;\n  border-radius: var(--mat-sys-corner-extra-small);\n  display: flex;\n  overflow: hidden;\n  flex-shrink: 0;\n  align-items: center;\n  justify-content: space-between;\n}\n\n.example-selected-icon {\n  visibility: hidden;\n}\n\n.example-option[aria-selected='true'] .example-selected-icon {\n  visibility: visible;\n}\n\n.example-option[inert],\n.example-tree-item[inert] {\n  display: none;\n}\n\n.example-combobox-container:focus-within [data-active='true'] {\n  background: color-mix(\n    in srgb,\n    var(--mat-sys-on-surface) calc(var(--mat-sys-focus-state-layer-opacity) * 100%),\n    transparent\n  );\n}\n\n.example-combobox-container:focus-within [data-active='true'][aria-selected='true'] {\n  background: color-mix(\n    in srgb,\n    var(--mat-sys-primary) calc(var(--mat-sys-pressed-state-layer-opacity) * 100%),\n    transparent\n  );\n  color: var(--mat-sys-primary);\n}\n\n.example-tree {\n  padding: 10px;\n  overflow-x: scroll;\n}\n\n.example-tree-item {\n  cursor: pointer;\n  list-style: none;\n  text-decoration: none;\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n  padding: 0.3rem 1rem;\n}\n\nli[aria-expanded='false'] + ul[role='group'] {\n  display: none;\n}\n\nul[role='group'] {\n  padding-inline-start: 1rem;\n}\n\n.example-icon {\n  margin: 0;\n  width: 24px;\n}\n\n.example-parent-icon {\n  transition: transform 0.2s ease;\n}\n\n.example-tree-item[aria-expanded='true'] .example-parent-icon {\n  transform: rotate(90deg);\n}\n\n.example-selected-icon {\n  visibility: hidden;\n  margin-left: auto;\n}\n\n.example-tree-item[aria-current] .example-selected-icon,\n.example-tree-item[aria-selected='true'] .example-selected-icon {\n  visibility: visible;\n}\n"], dependencies: [{ kind: "directive", type: Combobox, selector: "[ngCombobox]", inputs: ["filterMode", "disabled", "readonly", "firstMatch"], exportAs: ["ngCombobox"] }, { kind: "directive", type: ComboboxInput, selector: "input[ngComboboxInput]", inputs: ["value"], outputs: ["valueChange"], exportAs: ["ngComboboxInput"] }, { kind: "directive", type: ComboboxPopupContainer, selector: "ng-template[ngComboboxPopupContainer]", exportAs: ["ngComboboxPopupContainer"] }, { kind: "directive", type: Listbox, selector: "[ngListbox]", inputs: ["orientation", "multi", "wrap", "skipDisabled", "focusMode", "selectionMode", "typeaheadDelay", "disabled", "readonly", "value"], outputs: ["valueChange"], exportAs: ["ngListbox"] }, { kind: "directive", type: Option, selector: "[ngOption]", inputs: ["value", "disabled", "label"], exportAs: ["ngOption"] }, { kind: "ngmodule", type: FormsModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: i0, type: ComboboxReadonlyExample, decorators: [{
            type: Component,
            args: [{ selector: 'combobox-readonly-example', imports: [
                        Combobox,
                        ComboboxInput,
                        ComboboxPopup,
                        ComboboxPopupContainer,
                        ...
                        Option,
                        FormsModule,
                    ], changeDetection: ChangeDetectionStrategy.OnPush, template: "<div ngCombobox #combobox=\"ngCombobox\" class=\"example-combobox-container\" [readonly]=\"true\">\n  <div class=\"example-combobox-input-container\">\n    <input\n      ngComboboxInput\n      class=\"example-combobox-input\"\n      placeholder=\"Search...\"\n      [(value)]=\"searchString\"\n    />\n    <span class=\"material-symbols-outlined example-icon example-arrow-icon\">arrow_drop_down</span>\n  </div>\n\n  <div popover=\"manual\" #popover class=\"example-popover\">\n    <ng-template ngComboboxPopupContainer>\n      <div ngListbox class=\"example-listbox\">\n        @for (option of options(); track option) {\n          <div\n            class=\"example-option example-selectable example-stateful\"\n            ngOption\n            [value]=\"option\"\n            [label]=\"option\"\n          >\n            <span>{{option}}</span>\n            <span\n              aria-hidden=\"true\"\n              class=\"material-symbols-outlined example-icon example-selected-icon\"\n              >check</span\n            >\n          </div>\n        }\n      </div>\n    </ng-template>\n  </div>\n</div>\n", styles: [".example-combobox-container {\n  position: relative;\n  width: 300px;\n  display: flex;\n  flex-direction: column;\n  border: 1px solid var(--mat-sys-outline);\n  border-radius: var(--mat-sys-corner-extra-small);\n}\n\n.example-combobox-input-container {\n  display: flex;\n  position: relative;\n  align-items: center;\n  border-radius: var(--mat-sys-corner-extra-small);\n}\n\n.example-combobox-input {\n  border-radius: var(--mat-sys-corner-extra-small);\n}\n\n.example-combobox-input[readonly='true'] {\n  cursor: pointer;\n  padding: 0.7rem 1rem;\n}\n\n.example-combobox-container:focus-within .example-combobox-input {\n  outline: 1.5px solid var(--mat-sys-primary);\n  box-shadow: 0 0 0 4px color-mix(in srgb, var(--mat-sys-primary) 25%, transparent);\n}\n\n.example-icon {\n  width: 24px;\n  height: 24px;\n  font-size: 20px;\n  display: grid;\n  place-items: center;\n  pointer-events: none;\n}\n\n.example-search-icon {\n  padding: 0 0.5rem;\n  position: absolute;\n  opacity: 0.8;\n}\n\n.example-arrow-icon {\n  padding: 0 0.5rem;\n  position: absolute;\n  right: 0;\n  opacity: 0.8;\n  transition: transform 0.2s ease;\n}\n\n.example-combobox-input[aria-expanded='true'] + .example-arrow-icon {\n  transform: rotate(180deg);\n}\n\n.example-combobox-input {\n  width: 100%;\n  border: none;\n  outline: none;\n  font-size: 1rem;\n  padding: 0.7rem 1rem 0.7rem 2.5rem;\n  background-color: var(--mat-sys-surface);\n}\n\n.example-popover {\n  margin: 0;\n  padding: 0;\n  border: 1px solid var(--mat-sys-outline);\n  border-radius: var(--mat-sys-corner-extra-small);\n  background-color: var(--mat-sys-surface);\n}\n\n.example-listbox {\n  display: flex;\n  flex-direction: column;\n  overflow: auto;\n  max-height: 10rem;\n  padding: 0.5rem;\n}\n\n.example-option {\n  cursor: pointer;\n  padding: 0.3rem 1rem;\n  border-radius: var(--mat-sys-corner-extra-small);\n  display: flex;\n  overflow: hidden;\n  flex-shrink: 0;\n  align-items: center;\n  justify-content: space-between;\n}\n\n.example-selected-icon {\n  visibility: hidden;\n}\n\n.example-option[aria-selected='true'] .example-selected-icon {\n  visibility: visible;\n}\n\n.example-option[inert],\n.example-tree-item[inert] {\n  display: none;\n}\n\n.example-combobox-container:focus-within [data-active='true'] {\n  background: color-mix(\n    in srgb,\n    var(--mat-sys-on-surface) calc(var(--mat-sys-focus-state-layer-opacity) * 100%),\n    transparent\n  );\n}\n\n.example-combobox-container:focus-within [data-active='true'][aria-selected='true'] {\n  background: color-mix(\n    in srgb,\n    var(--mat-sys-primary) calc(var(--mat-sys-pressed-state-layer-opacity) * 100%),\n    transparent\n  );\n  color: var(--mat-sys-primary);\n}\n\n.example-tree {\n  padding: 10px;\n  overflow-x: scroll;\n}\n\n.example-tree-item {\n  cursor: pointer;\n  list-style: none;\n  text-decoration: none;\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n  padding: 0.3rem 1rem;\n}\n\nli[aria-expanded='false'] + ul[role='group'] {\n  display: none;\n}\n\nul[role='group'] {\n  padding-inline-start: 1rem;\n}\n\n.example-icon {\n  margin: 0;\n  width: 24px;\n}\n\n.example-parent-icon {\n  transition: transform 0.2s ease;\n}\n\n.example-tree-item[aria-expanded='true'] .example-parent-icon {\n  transform: rotate(90deg);\n}\n\n.example-selected-icon {\n  visibility: hidden;\n  margin-left: auto;\n}\n\n.example-tree-item[aria-current] .example-selected-icon,\n.example-tree-item[aria-selected='true'] .example-selected-icon {\n  visibility: visible;\n}\n"] }]
        }], ctorParameters: () => [] });
