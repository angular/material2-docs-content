...
class BadgeOverviewExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      type: i1.MatBadge,
      selector: "[matBadge]",
      inputs: ["matBadgeColor", "matBadgeOverlap", "matBadgeDisabled", "matBadgePosition", "matBadge", "matBadgeDescription", "matBadgeSize", "matBadgeHidden"]
    }, {
      kind: "ngmodule",
...
class BadgeHarnessExample {
  simpleContent = signal('S', ...(ngDevMode ? [{
    debugName: "simpleContent"
  }] : []));
  overlap = signal(true, ...(ngDevMode ? [{
    debugName: "overlap"
  }] : []));
...
//# sourceMappingURL=material-badge.mjs.map
