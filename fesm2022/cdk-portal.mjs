...
class CdkPortalOverviewExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    viewQueries: [{
      propertyName: "templatePortalContent",
      first: true,
      predicate: ["templatePortalContent"],
      descendants: true
    }, {
      propertyName: "domPortalContent",
      first: true,
      predicate: ["domPortalContent"],
      descendants: true
    }],
    ngImport: i0,
...
//# sourceMappingURL=cdk-portal.mjs.map
