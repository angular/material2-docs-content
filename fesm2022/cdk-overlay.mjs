...
class CdkOverlayBasicExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    ngImport: i0,
    template: "<!-- This button is the origin to which the overlay is attached -->\n<button (click)=\"isOpen.update(isOpen => !isOpen)\" type=\"button\" cdkOverlayOrigin #origin=\"cdkOverlayOrigin\">\n  {{isOpen() ? \"Close\" : \"Open\"}}\n</button>\n\n<!-- This template displays the overlay content and is connected to the button -->\n<ng-template\n  cdkConnectedOverlay\n  [cdkConnectedOverlayOrigin]=\"origin\"\n  [cdkConnectedOverlayOpen]=\"isOpen()\"\n  (detach)=\"isOpen.set(false)\"\n>\n  <ul class=\"example-list\">\n    <li>Item 1</li>\n    <li>Item 2</li>\n    <li>Item 3</li>\n  </ul>\n</ng-template>\n",
...
//# sourceMappingURL=cdk-overlay.mjs.map
