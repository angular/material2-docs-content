...
import { inject, Component, signal, model, viewChild, TemplateRef } from '@angular/core';
...
class DialogContentExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    ngImport: i0,
    template: "<button matButton (click)=\"openDialog()\">Open dialog</button>\n",
    dependencies: [{
      kind: "ngmodule",
...
class DialogContentExampleDialog {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "directive",
      type: i3.MatDialogActions,
      selector: "[mat-dialog-actions], mat-dialog-actions, [matDialogActions]",
      inputs: ["align"]
    }, {
      kind: "directive",
      type: i3.MatDialogContent,
...
class DialogDataExampleDialog {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    ngImport: i0,
    template: "<h2 mat-dialog-title>Favorite Animal</h2>\n<mat-dialog-content>\n  My favorite animal is:\n  <ul>\n    <li>\n      @if (data.animal === 'panda') {\n        <span>&#10003;</span>\n      } Panda\n    </li>\n    <li>\n      @if (data.animal === 'unicorn') {\n        <span>&#10003;</span>\n      } Unicorn\n    </li>\n    <li>\n      @if (data.animal === 'lion') {\n        <span>&#10003;</span>\n      } Lion\n    </li>\n  </ul>\n</mat-dialog-content>\n",
    dependencies: [{
      kind: "directive",
      type: MatDialogTitle,
      selector: "[mat-dialog-title], [matDialogTitle]",
...
class DialogElementsExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    ngImport: i0,
    template: "<button matButton (click)=\"openDialog()\">Launch dialog</button>\n",
    dependencies: [{
      kind: "ngmodule",
      type: MatButtonModule
    }, {
...
class DialogOverviewExample {
  animal = signal('', ...(ngDevMode ? [{
    debugName: "animal"
  }] : []));
  name = model('', ...(ngDevMode ? [{
    debugName: "name"
  }] : []));
  dialog = inject(MatDialog);
  openDialog() {
...
class DialogOverviewExampleDialog {
  ...
  data = inject(MAT_DIALOG_DATA);
  animal = model(this.data.animal, ...(ngDevMode ? [{
    debugName: "animal"
  }] : []));
  onNoClick() {
...
class DialogFromMenuExample {
  menuTrigger = viewChild.required(MatMenuTrigger, ...(ngDevMode ? [{
    debugName: "menuTrigger"
  }] : []));
  dialog = inject(MatDialog);
  openDialog() {
...
class DialogHarnessExample {
  dialogTemplate = viewChild.required(TemplateRef, ...(ngDevMode ? [{
    debugName: "dialogTemplate"
  }] : []));
  dialog = inject(MatDialog);
  open(config) {
...
class DialogAnimationsExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    ngImport: i0,
    template: "<button matButton=\"elevated\" (click)=\"openDialog('0ms', '0ms')\">Open dialog without animation</button>\n<button matButton=\"elevated\" (click)=\"openDialog('3000ms', '1500ms')\">Open dialog slowly</button>\n",
    styles: ["button {\n  margin-right: 8px;\n}\n"],
    dependencies: [{
      kind: "ngmodule",
      type: MatButtonModule
...
//# sourceMappingURL=material-dialog.mjs.map
