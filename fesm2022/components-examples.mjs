const EXAMPLE_COMPONENTS = {
  ...
  "list-action": {
    "packagePath": "material/list/list-action",
    "title": "Action list",
    "componentName": "ListActionExample",
    "files": ["list-action-example.ts", "list-action-example.html"],
    "selector": "list-action-example",
    "additionalComponents": [],
    "primaryFile": "list-action-example.ts",
    "importPath": "material/list"
  },
  "list-avatar": {
    "packagePath": "material/list/list-avatar",
    "title": "Selection list with avatars",
    "componentName": "ListAvatarExample",
    "files": ["list-avatar-example.ts", "list-avatar-example.html"],
    "selector": "list-avatar-example",
    "additionalComponents": [],
    "primaryFile": "list-avatar-example.ts",
    "importPath": "material/list"
  },
  "list-harness": {
  ...
  "list-navigation": {
    "packagePath": "material/list/list-navigation",
    "title": "Navigation list",
    "componentName": "ListNavigationExample",
    "files": ["list-navigation-example.ts", "list-navigation-example.html"],
    "selector": "list-navigation-example",
    "additionalComponents": [],
    "primaryFile": "list-navigation-example.ts",
    "importPath": "material/list"
  },
  "list-overview": {
