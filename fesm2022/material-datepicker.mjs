...
class DateRangePickerComparisonExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "component",
      type: i3.MatDatepickerToggle,
      selector: "mat-datepicker-toggle",
      inputs: ["for", "tabIndex", "aria-label", "disabled", "disableRipple"],
      exportAs: ["matDatepickerToggle"]
    }, {
      kind: "component",
      type: i3.MatDateRangeInput,
      selector: "mat-date-range-input",
      inputs: ["rangePicker", "required", "dateFilter", "min", "max", "disabled", "separator", "comparisonStart", "comparisonEnd"],
      exportAs: ["matDateRangeInput"]
    }, {
      kind: "directive",
      type: i3.MatStartDate,
...
class DatepickerActionsExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "component",
      type: i3.MatDatepicker,
      selector: "mat-datepicker",
      exportAs: ["matDatepicker"]
    }, {
      kind: "directive",
      type: i3.MatDatepickerInput,
      ...
      kind: "component",
      type: i3.MatDatepickerActions,
      selector: "mat-datepicker-actions, mat-date-range-picker-actions"
    }, {
      kind: "directive",
      type: i3.MatDatepickerCancel,
      selector: "[matDatepickerCancel], [matDateRangePickerCancel]"
    }, {
      kind: "directive",
      type: i3.MatDatepickerApply,
...
class ExampleHeader {
  ...
  periodLabel = signal('', ...(ngDevMode ? [{
    debugName: "periodLabel"
  }] : []));
  constructor() {
    this._calendar.stateChanges.pipe(startWith(null), takeUntil(this._destroyed)).subscribe(() => {
      this.periodLabel.set(this._dateAdapter.format(this._calendar.activeDate, this._dateFormats.display.monthYearLabel).toLocaleUpperCase());
    });
  }
  ngOnDestroy() {
...
class DatepickerCustomIconExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "directive",
      type: i3.MatDatepickerToggleIcon,
...
class DatepickerHarnessExample {
  date = model(null, ...(ngDevMode ? [{
    debugName: "date"
  }] : []));
  minDate = signal(null, ...(ngDevMode ? [{
    debugName: "minDate"
  }] : []));
  static ɵfac = i0.ɵɵngDeclareFactory({
    minVersion: "12.0.0",
...
class DatepickerLocaleExample {
  ...
  _locale = signal(inject(MAT_DATE_LOCALE), ...(ngDevMode ? [{
    debugName: "_locale"
  }] : []));
...
class DatepickerDialogExample {
  ...
  selectedDate = model(null, ...(ngDevMode ? [{
    debugName: "selectedDate"
  }] : []));
  openDialog() {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    inputs: {
      selectedDate: {
        classPropertyName: "selectedDate",
        publicName: "selectedDate",
        isSignal: true,
        isRequired: false,
        transformFunction: null
      }
...
class DatepickerDialogExampleDialog {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "directive",
      type: i3$3.MatDialogClose,
      selector: "[mat-dialog-close], [matDialogClose]",
      inputs: ["aria-label", "type", "mat-dialog-close", "matDialogClose"],
      exportAs: ["matDialogClose"]
    }, {
      kind: "directive",
      type: i3$3.MatDialogTitle,
      selector: "[mat-dialog-title], [matDialogTitle]",
      inputs: ["id"],
      exportAs: ["matDialogTitle"]
    }, {
      kind: "directive",
      type: i3$3.MatDialogActions,
      selector: "[mat-dialog-actions], mat-dialog-actions, [matDialogActions]",
      inputs: ["align"]
    }, {
      kind: "directive",
      type: i3$3.MatDialogContent,
