...
class CdkVirtualScrollAppendOnlyExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "directive",
      type: i1.CdkFixedSizeVirtualScroll,
      selector: "cdk-virtual-scroll-viewport[itemSize]",
      inputs: ["itemSize", "minBufferPx", "maxBufferPx"]
    }, {
      kind: "directive",
      type: i1.CdkVirtualForOf,
      selector: "[cdkVirtualFor][cdkVirtualForOf]",
      inputs: ["cdkVirtualForOf", "cdkVirtualForTrackBy", "cdkVirtualForTemplate", "cdkVirtualForTemplateCacheSize"]
    }, {
      kind: "component",
      type: i1.CdkVirtualScrollViewport,
...
class CdkVirtualScrollWindowScrollingExample {
  shouldRun = input(/(^|.)(stackblitz|webcontainer).(io|com)$/.test(window.location.host), ...(ngDevMode ? [{
    debugName: "shouldRun"
  }] : []));
  items = Array.from({
    length: 100000
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    inputs: {
      shouldRun: {
        classPropertyName: "shouldRun",
        publicName: "shouldRun",
        isSignal: true,
        isRequired: false,
