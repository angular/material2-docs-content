...
class CdkPopoverEditCdkTableFlexExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "directive",
      type: i1$1.CdkPopoverEdit,
      selector: "[cdkPopoverEdit]:not([cdkPopoverEditTabOut])",
      inputs: ["cdkPopoverEdit", "cdkPopoverEditContext", "cdkPopoverEditColspan", "cdkPopoverEditDisabled", "cdkPopoverEditAriaLabel"]
    }, {
      kind: "directive",
      type: i1$1.CdkRowHoverContent,
      selector: "[cdkRowHoverContent]"
    }, {
      kind: "directive",
      type: i1$1.CdkEditControl,
      selector: "form[cdkEditControl]",
      inputs: ["cdkEditControlClickOutBehavior", "cdkEditControlPreservedFormValue", "cdkEditControlIgnoreSubmitUnlessValid"],
      outputs: ["cdkEditControlPreservedFormValueChange"]
    }, {
      kind: "directive",
...
class CdkPopoverEditTabOutVanillaTableExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "directive",
      type: i1$1.CdkPopoverEditTabOut,
...
//# sourceMappingURL=cdk-experimental-popover-edit.mjs.map
