...
class ChipsAutocompleteExample {
  ...
  currentFruit = model('', ...(ngDevMode ? [{
    debugName: "currentFruit"
  }] : []));
  fruits = signal(['Lemon'], ...(ngDevMode ? [{
    debugName: "fruits"
  }] : []));
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    inputs: {
      currentFruit: {
        classPropertyName: "currentFruit",
        publicName: "currentFruit",
        isSignal: true,
        isRequired: false,
    ...
    outputs: {
      currentFruit: "currentFruitChange"
    },
    ngImport: i0,
...
class ChipsDragDropExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      inputs: ["role", "id", "aria-label", "aria-description", "value", "color", "removable", "highlighted", "disableRipple", "disabled"],
...
class ChipsInputExample {
  ...
  add(event) {
    const value = (event.value || '').trim();
    if (value) {
      this.fruits.update(fruits => [...fruits, {
        name: value
      }]);
    }
...
class ChipsStackedExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    ngImport: i0,
    template: "<mat-chip-listbox class=\"mat-mdc-chip-set-stacked\" aria-label=\"Cutest dog breeds\">\n  @for (dog of bestBoys; track dog) {\n    <mat-chip-option selected>{{dog}}</mat-chip-option>\n  }\n</mat-chip-listbox>\n",
    ...
    dependencies: [{
      ...
      kind: "component",
      type: i2.MatChipListbox,
      selector: "mat-chip-listbox",
      inputs: ["multiple", "aria-orientation", "selectable", "compareWith", "required", "hideSingleSelectionIndicator", "value"],
      outputs: ["change"]
    }, {
      kind: "component",
      type: i2.MatChipOption,
...
class ChipsHarnessExample {
  isDisabled = signal(false, ...(ngDevMode ? [{
...
class ChipsFormControlExample {
  keywords = signal(['angular', 'how-to', 'tutorial', 'accessibility'], ...(ngDevMode ? [{
    debugName: "keywords"
  }] : []));
...
class ChipsReactiveFormExample {
  reactiveKeywords = signal(['angular', 'how-to', 'tutorial', 'accessibility'], ...(ngDevMode ? [{
    debugName: "reactiveKeywords"
  }] : []));
  formControl = new FormControl(['angular']);
  announcer = inject(LiveAnnouncer);
...
class ChipsTemplateFormExample {
  templateKeywords = signal(['angular', 'how-to', 'tutorial', 'accessibility'], ...(ngDevMode ? [{
    debugName: "templateKeywords"
  }] : []));
  announcer = inject(LiveAnnouncer);
