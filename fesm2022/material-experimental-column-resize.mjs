...
class DefaultEnabledColumnResizeExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "directive",
      type: i1.MatDefaultEnabledColumnResize,
      selector: "table[mat-table]"
    }, {
      kind: "directive",
      type: i1.MatDefaultResizable,
      selector: "mat-header-cell:not([disableResize]), th[mat-header-cell]:not([disableResize])",
      inputs: ["matResizableMinWidthPx", "matResizableMaxWidthPx"]
    }, {
      kind: "ngmodule",
      type: MatTableModule
    }, {
      ...
      kind: "directive",
      type: i1$1.MatHeaderCellDef,
      selector: "[matHeaderCellDef]"
    }, {
      kind: "directive",
      type: i1$1.MatHeaderRowDef,
      selector: "[matHeaderRowDef]",
      inputs: ["matHeaderRowDef", "matHeaderRowDefSticky"]
    }, {
      kind: "directive",
      type: i1$1.MatColumnDef,
      selector: "[matColumnDef]",
      inputs: ["matColumnDef"]
    }, {
      kind: "directive",
      type: i1$1.MatCellDef,
      selector: "[matCellDef]"
    }, {
      kind: "directive",
      type: i1$1.MatRowDef,
...
class DefaultEnabledColumnResizeFlexExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "directive",
      type: i1.MatDefaultEnabledColumnResizeFlex,
      selector: "mat-table"
    }, {
      kind: "directive",
      type: i1.MatDefaultResizable,
...
class OptInColumnResizeExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "directive",
      type: i1.MatColumnResize,
      selector: "table[mat-table][columnResize]"
    }, {
      kind: "directive",
      type: i1.MatResizable,
