...
class ButtonToggleHarnessExample {
  ...
  appearance = signal('standard', ...(ngDevMode ? [{
...
class ButtonToggleFormsExample {
  ...
  fontStyle = signal(undefined, ...(ngDevMode ? [{
    debugName: "fontStyle"
  }] : []));
  static ɵfac = i0.ɵɵngDeclareFactory({
    minVersion: "12.0.0",
...
class ButtonToggleModeExample {
  hideSingleSelectionIndicator = signal(false, ...(ngDevMode ? [{
    debugName: "hideSingleSelectionIndicator"
  }] : []));
  hideMultipleSelectionIndicator = signal(false, ...(ngDevMode ? [{
    debugName: "hideMultipleSelectionIndicator"
  }] : []));
...
//# sourceMappingURL=material-button-toggle.mjs.map
