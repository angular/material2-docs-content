...
class SortHarnessExample {
  disableThirdHeader = signal(false, ...(ngDevMode ? [{
    debugName: "disableThirdHeader"
  }] : []));
  desserts = [{
    name: 'Frozen yogurt',
    calories: 159,
