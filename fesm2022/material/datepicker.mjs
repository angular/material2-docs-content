...
class ExampleHeader {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.1.0-next.1", ngImport: i0, type: ExampleHeader, deps: [{ token: i3.MatCalendar }, { token: i1$1.DateAdapter }, { token: MAT_DATE_FORMATS }], target: i0.ɵɵFactoryTarget.Component }); }
...
class DatepickerLocaleExample {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.1.0-next.1", ngImport: i0, type: DatepickerLocaleExample, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
