...
class MatSelectionColumnExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "directive",
      type: i2.MatSelection,
      selector: "[matSelection]",
      inputs: ["matSelectionMultiple"],
      outputs: ["matSelectionChange"],
      exportAs: ["matSelection"]
    }, {
      kind: "component",
      type: i2.MatSelectionColumn,
      selector: "mat-selection-column",
      inputs: ["name"]
    }, {
      kind: "directive",
      type: i2.MatRowSelection,
      selector: "[matRowSelection]",
      inputs: ["matRowSelectionIndex", "matRowSelectionValue"]
    }]
  });
}
...
const ELEMENT_NAMES = ['Hydrogen', 'Helium', 'Lithium', 'Beryllium', 'Boron', 'Carbon', 'Nitrogen', 'Oxygen', 'Fluorine', 'Neon', 'Sodium', 'Magnesium', 'Aluminum', 'Silicon', 'Phosphorus', 'Sulfur', 'Chlorine', 'Argon', 'Potassium', 'Calcium'];
