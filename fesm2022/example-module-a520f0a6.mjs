...
const EXAMPLE_COMPONENTS = {
    "cdk-listbox": {
        "packagePath": "cdk-experimental/listbox/cdk-listbox",
        "title": "Listbox using UI Patterns.",
        "componentName": "CdkListboxExample",
        "files": [
            "cdk-listbox-example.ts",
            "cdk-listbox-example.html",
            "cdk-listbox-example.css"
        ],
        "selector": "cdk-listbox-example",
        "additionalComponents": [],
        "primaryFile": "cdk-listbox-example.ts",
        "importPath": "cdk-experimental/listbox"
    },
...
async function loadExample(id) {
    switch (id) {
        case 'cdk-listbox':
            return import('@angular/components-examples/cdk-experimental/listbox');
...
export { EXAMPLE_COMPONENTS as E, loadExample as l };
//# sourceMappingURL=example-module-a520f0a6.mjs.map
