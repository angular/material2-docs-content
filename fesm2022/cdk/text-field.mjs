...
class TextFieldAutofillMonitorExample {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.1.0", ngImport: i0, type: TextFieldAutofillMonitorExample, deps: [{ token: i1$1.AutofillMonitor }], target: i0.ɵɵFactoryTarget.Component }); }
