...
class SidenavAutosizeExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      type: i1.MatDrawer,
      selector: "mat-drawer",
      inputs: ["position", "mode", "disableClose", "autoFocus", "opened"],
      outputs: ["openedChange", "opened", "openedStart", "closed", "closedStart", "positionChanged"],
      exportAs: ["matDrawer"]
    }, {
      kind: "component",
      type: i1.MatDrawerContainer,
...
class SidenavDisableCloseExample {
  sidenav = viewChild.required('sidenav', ...(ngDevMode ? [{
    debugName: "sidenav"
  }] : []));
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "component",
      type: i1.MatSidenavContainer,
      selector: "mat-sidenav-container",
      exportAs: ["matSidenavContainer"]
    }, {
      kind: "component",
      type: i1.MatSidenavContent,
...
i0.ɵɵngDeclareClassMetadata({
  ...
  decorators: [{
    ...
    args: [{
      selector: 'sidenav-fixed-example',
      imports: [MatToolbarModule, MatSidenavModule, FormsModule, ReactiveFormsModule, MatCheckboxModule, MatFormFieldModule, MatButtonModule, MatInputModule],
      template: "@if (shouldRun) {\n  <mat-toolbar class=\"example-header\">Header</mat-toolbar>\n\n  <mat-sidenav-container class=\"example-container\">\n    <mat-sidenav #sidenav mode=\"side\" opened class=\"example-sidenav\"\n                 [fixedInViewport]=\"options.value.fixed\" [fixedTopGap]=\"options.value.top\"\n                 [fixedBottomGap]=\"options.value.bottom\">\n      {{options.value.fixed ? 'Fixed' : 'Non-fixed'}} Sidenav\n    </mat-sidenav>\n\n    <mat-sidenav-content [formGroup]=\"options\">\n      <p><mat-checkbox formControlName=\"fixed\">Fixed</mat-checkbox></p>\n      <p><mat-form-field>\n        <mat-label>Top gap</mat-label>\n        <input matInput type=\"number\" formControlName=\"top\">\n      </mat-form-field></p>\n      <p><mat-form-field>\n        <mat-label>Bottom gap</mat-label>\n        <input matInput type=\"number\" formControlName=\"bottom\">\n      </mat-form-field></p>\n      <p><button matButton (click)=\"sidenav.toggle()\">Toggle</button></p>\n    </mat-sidenav-content>\n  </mat-sidenav-container>\n\n  <mat-toolbar class=\"example-footer\">Footer</mat-toolbar>\n} @else {\n  <div>Please open on StackBlitz to see result</div>\n}\n",
      styles: [".example-container {\n  position: absolute;\n  top: 60px;\n  bottom: 60px;\n  left: 0;\n  right: 0;\n}\n\n.example-sidenav {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 200px;\n  background: rgba(255, 0, 0, 0.5);\n}\n\n.example-header {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n}\n\n.example-footer {\n  position: fixed;\n  bottom: 0;\n  left: 0;\n  right: 0;\n}\n"]
    }]
  }]
...
class SidenavConfigurableFocusTrapExample {
  mode = new FormControl('over');
  hasBackdrop = new FormControl(null);
  position = new FormControl('start');
  shouldRun = /(^|.)(stackblitz|webcontainer).(io|com)$/.test(window.location.host);
  static ɵfac = i0.ɵɵngDeclareFactory({
    minVersion: "12.0.0",
    version: "22.0.6",
...
class SidenavResponsiveExample {
  ...
  isMobile = signal(true, ...(ngDevMode ? [{
    debugName: "isMobile"
  }] : []));
  _mobileQuery;
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "component",
      type: i1$5.MatNavList,
      selector: "mat-nav-list",
      exportAs: ["matNavList"]
    }, {
      kind: "component",
      type: i1$5.MatListItem,
...
//# sourceMappingURL=material-sidenav.mjs.map
