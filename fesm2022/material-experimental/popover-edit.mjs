...
class PopoverEditMatTableExample {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.1.1", ngImport: i0, type: PopoverEditMatTableExample, deps: [{ token: i1$1.MatSnackBar }], target: i0.ɵɵFactoryTarget.Component }); }
