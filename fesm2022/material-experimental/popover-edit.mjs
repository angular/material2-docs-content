...
class PopoverEditMatTableExample {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.0-next.6", ngImport: i0, type: PopoverEditMatTableExample, deps: [{ token: i1$1.MatSnackBar }], target: i0.ɵɵFactoryTarget.Component }); }
