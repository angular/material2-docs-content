...
class TimepickerDatepickerIntegrationExample {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    dependencies: [{
      ...
      kind: "component",
      type: i3$2.MatDatepicker,
      selector: "mat-datepicker",
      exportAs: ["matDatepicker"]
    }, {
      kind: "directive",
      type: i3$2.MatDatepickerInput,
      selector: "input[matDatepicker]",
      inputs: ["matDatepicker", "min", "max", "matDatepickerFilter"],
      exportAs: ["matDatepickerInput"]
    }, {
      kind: "component",
      type: i3$2.MatDatepickerToggle,
...
class TimepickerOptionsExample {
  customOptions = [{
    label: 'Morning',
    value: new Date(2024, 0, 1, 9, 0, 0)
  }, {
    label: 'Noon',
    value: new Date(2024, 0, 1, 12, 0, 0)
  }, {
    label: 'Evening',
...
class TimepickerHarnessExample {
  ...
  constructor() {
    ...
    this.date = signal(new Date(today.getFullYear(), today.getMonth(), today.getDate(), 11, 45), ...(ngDevMode ? [{
      debugName: "date"
    }] : []));
  }
  static ɵfac = i0.ɵɵngDeclareFactory({
...
//# sourceMappingURL=material-timepicker.mjs.map
