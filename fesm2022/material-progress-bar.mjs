...
class ProgressBarConfigurableExample {
  ...
  bufferValue = signal(75, ...(ngDevMode ? [{
    debugName: "bufferValue"
  }] : []));
  static ɵfac = i0.ɵɵngDeclareFactory({
    minVersion: "12.0.0",
    version: "22.1.0-next.5",
