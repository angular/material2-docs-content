...
/** @nocollapse */ TableBasicExample.ngFactoryDef = function TableBasicExample_Factory(t) { return new (t || TableBasicExample)(); };
/** @nocollapse */ TableBasicExample.ngComponentDef = ɵɵdefineComponent({ type: TableBasicExample, selectors: [["table-basic-example"]], decls: 15, vars: 3, consts: [["mat-table", "", 1, "mat-elevation-z8", 3, "dataSource"], ["matColumnDef", "position"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "name"], ["matColumnDef", "weight"], ["matColumnDef", "symbol"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", ""], ["mat-cell", ""], ["mat-header-row", ""], ["mat-row", ""]], template: function TableBasicExample_Template(rf, ctx) { if (rf & 1) {
...
function TableExpandableRowsExample_tr_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("click", function TableExpandableRowsExample_tr_5_Template_tr_click_0_listener($event) { ɵɵrestoreView(_r54); const element_r52 = ctx.$implicit; const ctx_r53 = ɵɵnextContext(); return ctx_r53.expandedElement = ctx_r53.expandedElement === element_r52 ? null : element_r52; });
    ɵɵelementEnd();
} if (rf & 2) {
...
/** @nocollapse */ TableHttpExample.ngFactoryDef = function TableHttpExample_Factory(t) { return new (t || TableHttpExample)(ɵɵdirectiveInject(HttpClient)); };
/** @nocollapse */ TableHttpExample.ngComponentDef = ɵɵdefineComponent({ type: TableHttpExample, selectors: [["table-http-example"]], viewQuery: function TableHttpExample_Query(rf, ctx) { if (rf & 1) {
...
const _c0$1 = ["item-description", "cost-description"];
...
/** @nocollapse */ TableOverviewExample.ngFactoryDef = function TableOverviewExample_Factory(t) { return new (t || TableOverviewExample)(); };
/** @nocollapse */ TableOverviewExample.ngComponentDef = ɵɵdefineComponent({ type: TableOverviewExample, selectors: [["table-overview-example"]], viewQuery: function TableOverviewExample_Query(rf, ctx) { if (rf & 1) {
...
/** @nocollapse */ TablePaginationExample.ngFactoryDef = function TablePaginationExample_Factory(t) { return new (t || TablePaginationExample)(); };
/** @nocollapse */ TablePaginationExample.ngComponentDef = ɵɵdefineComponent({ type: TablePaginationExample, selectors: [["table-pagination-example"]], viewQuery: function TablePaginationExample_Query(rf, ctx) { if (rf & 1) {
        ɵɵstaticViewQuery(MatPaginator, true);
    } if (rf & 2) {
        var _t;
        ɵɵqueryRefresh((_t = ɵɵloadQuery())) && (ctx.paginator = _t.first);
...
function TableSelectionExample_th_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("change", function TableSelectionExample_th_2_Template_mat_checkbox_change_1_listener($event) { ɵɵrestoreView(_r185); const ctx_r184 = ɵɵnextContext(); return $event ? ctx_r184.masterToggle() : null; });
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
...
function TableSelectionExample_td_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("change", function TableSelectionExample_td_3_Template_mat_checkbox_change_1_listener($event) { ɵɵrestoreView(_r188); const row_r186 = ctx.$implicit; const ctx_r189 = ɵɵnextContext(); return $event ? ctx_r189.selection.toggle(row_r186) : null; });
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
...
function TableSelectionExample_tr_17_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("click", function TableSelectionExample_tr_17_Template_tr_click_0_listener($event) { ɵɵrestoreView(_r196); const row_r194 = ctx.$implicit; const ctx_r195 = ɵɵnextContext(); return ctx_r195.selection.toggle(row_r194); });
    ɵɵelementEnd();
} }
/**
 * @record
...
/** @nocollapse */ TableSelectionExample.ngFactoryDef = function TableSelectionExample_Factory(t) { return new (t || TableSelectionExample)(); };
/** @nocollapse */ TableSelectionExample.ngComponentDef = ɵɵdefineComponent({ type: TableSelectionExample, selectors: [["table-selection-example"]], decls: 18, vars: 3, consts: [["mat-table", "", 1, "mat-elevation-z8", 3, "dataSource"], ["matColumnDef", "select"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "position"], ["matColumnDef", "name"], ["matColumnDef", "weight"], ["matColumnDef", "symbol"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 3, "click", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", ""], [3, "checked", "indeterminate", "aria-label", "change"], ["mat-cell", ""], [3, "checked", "aria-label", "click", "change"], ["mat-header-row", ""], ["mat-row", "", 3, "click"]], template: function TableSelectionExample_Template(rf, ctx) { if (rf & 1) {
        ɵɵelementStart(0, "table", 0);
        ɵɵelementContainerStart(1, 1);
...
/** @nocollapse */ TableSortingExample.ngFactoryDef = function TableSortingExample_Factory(t) { return new (t || TableSortingExample)(); };
/** @nocollapse */ TableSortingExample.ngComponentDef = ɵɵdefineComponent({ type: TableSortingExample, selectors: [["table-sorting-example"]], viewQuery: function TableSortingExample_Query(rf, ctx) { if (rf & 1) {
        ɵɵstaticViewQuery(MatSort, true);
    } if (rf & 2) {
        var _t;
        ɵɵqueryRefresh((_t = ɵɵloadQuery())) && (ctx.sort = _t.first);
...
/** @nocollapse */ TableStickyColumnsExample.ngFactoryDef = function TableStickyColumnsExample_Factory(t) { return new (t || TableStickyColumnsExample)(); };
/** @nocollapse */ TableStickyColumnsExample.ngComponentDef = ɵɵdefineComponent({ type: TableStickyColumnsExample, selectors: [["table-sticky-columns-example"]], decls: 19, vars: 3, consts: [[1, "example-container", "mat-elevation-z8"], ["mat-table", "", 3, "dataSource"], ["matColumnDef", "name", "sticky", ""], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "position"], ["matColumnDef", "weight"], ["matColumnDef", "symbol"], ["matColumnDef", "star", "stickyEnd", ""], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", ""], ["mat-cell", ""], ["mat-header-row", ""], ["mat-row", ""]], template: function TableStickyColumnsExample_Template(rf, ctx) { if (rf & 1) {
        ɵɵelementStart(0, "div", 0);
        ɵɵelementStart(1, "table", 1);
        ɵɵelementContainerStart(2, 2);
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
const _c0$4 = ["stickyHeaders", "matButtonToggleGroup"];
const _c1$1 = ["stickyFooters", "matButtonToggleGroup"];
const _c2 = ["stickyColumns", "matButtonToggleGroup"];
...
function TableStickyComplexFlexExample_mat_table_34_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "mat-table", 12);
    ɵɵelementContainerStart(1, 13);
    ɵɵtemplate(2, TableStickyComplexFlexExample_mat_table_34_mat_header_cell_2_Template, 2, 0, "mat-header-cell", 14);
    ɵɵtemplate(3, TableStickyComplexFlexExample_mat_table_34_mat_cell_3_Template, 2, 1, "mat-cell", 15);
    ɵɵtemplate(4, TableStickyComplexFlexExample_mat_table_34_mat_footer_cell_4_Template, 2, 0, "mat-footer-cell", 16);
    ɵɵelementContainerEnd();
    ɵɵelementContainerStart(5, 17);
    ɵɵtemplate(6, TableStickyComplexFlexExample_mat_table_34_mat_header_cell_6_Template, 2, 0, "mat-header-cell", 14);
    ɵɵtemplate(7, TableStickyComplexFlexExample_mat_table_34_mat_cell_7_Template, 2, 1, "mat-cell", 15);
    ɵɵtemplate(8, TableStickyComplexFlexExample_mat_table_34_mat_footer_cell_8_Template, 2, 0, "mat-footer-cell", 16);
    ɵɵelementContainerEnd();
    ɵɵelementContainerStart(9, 18);
    ɵɵtemplate(10, TableStickyComplexFlexExample_mat_table_34_mat_header_cell_10_Template, 2, 0, "mat-header-cell", 14);
    ɵɵtemplate(11, TableStickyComplexFlexExample_mat_table_34_mat_cell_11_Template, 2, 1, "mat-cell", 15);
    ɵɵtemplate(12, TableStickyComplexFlexExample_mat_table_34_mat_footer_cell_12_Template, 2, 0, "mat-footer-cell", 16);
    ɵɵelementContainerEnd();
    ɵɵelementContainerStart(13, 19);
    ɵɵtemplate(14, TableStickyComplexFlexExample_mat_table_34_mat_header_cell_14_Template, 2, 0, "mat-header-cell", 14);
    ɵɵtemplate(15, TableStickyComplexFlexExample_mat_table_34_mat_cell_15_Template, 2, 1, "mat-cell", 15);
    ɵɵtemplate(16, TableStickyComplexFlexExample_mat_table_34_mat_footer_cell_16_Template, 2, 0, "mat-footer-cell", 16);
    ɵɵelementContainerEnd();
    ɵɵelementContainerStart(17, 20);
    ɵɵtemplate(18, TableStickyComplexFlexExample_mat_table_34_mat_header_cell_18_Template, 2, 0, "mat-header-cell", 14);
    ɵɵtemplate(19, TableStickyComplexFlexExample_mat_table_34_mat_cell_19_Template, 2, 0, "mat-cell", 15);
    ɵɵtemplate(20, TableStickyComplexFlexExample_mat_table_34_mat_footer_cell_20_Template, 2, 0, "mat-footer-cell", 16);
    ɵɵelementContainerEnd();
    ɵɵtemplate(21, TableStickyComplexFlexExample_mat_table_34_mat_header_row_21_Template, 1, 0, "mat-header-row", 21);
    ɵɵtemplate(22, TableStickyComplexFlexExample_mat_table_34_mat_header_row_22_Template, 1, 0, "mat-header-row", 21);
    ɵɵtemplate(23, TableStickyComplexFlexExample_mat_table_34_mat_row_23_Template, 1, 0, "mat-row", 22);
    ɵɵtemplate(24, TableStickyComplexFlexExample_mat_table_34_mat_footer_row_24_Template, 1, 0, "mat-footer-row", 23);
    ɵɵtemplate(25, TableStickyComplexFlexExample_mat_table_34_mat_footer_row_25_Template, 1, 0, "mat-footer-row", 23);
    ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r233 = ɵɵnextContext();
    const _r232 = ɵɵreference(24);
    const _r230 = ɵɵreference(8);
    const _r231 = ɵɵreference(16);
...
/** @nocollapse */ TableStickyComplexFlexExample.ngComponentDef = ɵɵdefineComponent({ type: TableStickyComplexFlexExample, selectors: [["table-sticky-complex-flex-example"]], decls: 35, vars: 4, consts: [["mat-raised-button", "", 3, "click"], ["multiple", "", 1, "example-sticky-toggle-group", 3, "value"], ["value", "header-1"], ["value", "header-2"], ["value", "footer-1"], ["value", "footer-2"], ["value", "position"], ["value", "name"], ["value", "weight"], ["value", "symbol"], [1, "example-container", "mat-elevation-z8"], [3, "dataSource", 4, "ngFor", "ngForOf"], [3, "dataSource"], ["matColumnDef", "position", 3, "sticky"], [4, "matHeaderCellDef"], [4, "matCellDef"], [4, "matFooterCellDef"], ["matColumnDef", "name", 3, "sticky"], ["matColumnDef", "weight", 3, "stickyEnd"], ["matColumnDef", "symbol", 3, "stickyEnd"], ["matColumnDef", "filler"], [4, "matHeaderRowDef", "matHeaderRowDefSticky"], [4, "matRowDef", "matRowDefColumns"], [4, "matFooterRowDef", "matFooterRowDefSticky"]], template: function TableStickyComplexFlexExample_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵɵelementStart(7, "mat-button-toggle-group", 1, _c0$4);
        ...
        ɵɵelementStart(15, "mat-button-toggle-group", 1, _c1$1);
        ɵɵelementStart(17, "mat-button-toggle", 4);
        ɵɵtext(18, " Row 1 ");
        ɵɵelementEnd();
        ɵɵelementStart(19, "mat-button-toggle", 5);
        ɵɵtext(20, " Row 2 ");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        ɵɵelementStart(23, "mat-button-toggle-group", 1, _c2);
        ɵɵelementStart(25, "mat-button-toggle", 6);
        ɵɵtext(26, " Position ");
        ɵɵelementEnd();
        ɵɵelementStart(27, "mat-button-toggle", 7);
        ɵɵtext(28, " Name ");
        ɵɵelementEnd();
        ɵɵelementStart(29, "mat-button-toggle", 8);
        ɵɵtext(30, " Weight ");
        ɵɵelementEnd();
        ɵɵelementStart(31, "mat-button-toggle", 9);
        ɵɵtext(32, " Symbol ");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(33, "div", 10);
        ɵɵtemplate(34, TableStickyComplexFlexExample_mat_table_34_Template, 26, 14, "mat-table", 11);
        ɵɵelementEnd();
    } if (rf & 2) {
        ɵɵadvance(7);
        ɵɵproperty("value", _c3);
        ɵɵadvance(8);
        ɵɵproperty("value", _c4);
        ɵɵadvance(8);
        ɵɵproperty("value", _c5);
        ɵɵadvance(11);
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
const _c0$5 = ["stickyHeaders", "matButtonToggleGroup"];
const _c1$2 = ["stickyFooters", "matButtonToggleGroup"];
const _c2$1 = ["stickyColumns", "matButtonToggleGroup"];
...
function TableStickyComplexExample_table_34_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementContainerStart(1, 13);
    ɵɵtemplate(2, TableStickyComplexExample_table_34_th_2_Template, 2, 0, "th", 14);
    ɵɵtemplate(3, TableStickyComplexExample_table_34_td_3_Template, 2, 1, "td", 15);
    ɵɵtemplate(4, TableStickyComplexExample_table_34_td_4_Template, 2, 0, "td", 16);
    ɵɵelementContainerEnd();
    ɵɵelementContainerStart(5, 17);
    ɵɵtemplate(6, TableStickyComplexExample_table_34_th_6_Template, 2, 0, "th", 14);
    ɵɵtemplate(7, TableStickyComplexExample_table_34_td_7_Template, 2, 1, "td", 15);
    ɵɵtemplate(8, TableStickyComplexExample_table_34_td_8_Template, 2, 0, "td", 16);
    ɵɵelementContainerEnd();
    ɵɵelementContainerStart(9, 18);
    ɵɵtemplate(10, TableStickyComplexExample_table_34_th_10_Template, 2, 0, "th", 14);
    ɵɵtemplate(11, TableStickyComplexExample_table_34_td_11_Template, 2, 1, "td", 15);
    ɵɵtemplate(12, TableStickyComplexExample_table_34_td_12_Template, 2, 0, "td", 16);
    ɵɵelementContainerEnd();
    ɵɵelementContainerStart(13, 19);
    ɵɵtemplate(14, TableStickyComplexExample_table_34_th_14_Template, 2, 0, "th", 14);
    ɵɵtemplate(15, TableStickyComplexExample_table_34_td_15_Template, 2, 1, "td", 15);
    ɵɵtemplate(16, TableStickyComplexExample_table_34_td_16_Template, 2, 0, "td", 16);
    ɵɵelementContainerEnd();
    ɵɵelementContainerStart(17, 20);
    ɵɵtemplate(18, TableStickyComplexExample_table_34_th_18_Template, 2, 0, "th", 14);
    ɵɵtemplate(19, TableStickyComplexExample_table_34_td_19_Template, 2, 0, "td", 15);
    ɵɵtemplate(20, TableStickyComplexExample_table_34_td_20_Template, 2, 0, "td", 16);
    ɵɵelementContainerEnd();
    ɵɵtemplate(21, TableStickyComplexExample_table_34_tr_21_Template, 1, 0, "tr", 21);
    ɵɵtemplate(22, TableStickyComplexExample_table_34_tr_22_Template, 1, 0, "tr", 21);
    ɵɵtemplate(23, TableStickyComplexExample_table_34_tr_23_Template, 1, 0, "tr", 22);
    ɵɵtemplate(24, TableStickyComplexExample_table_34_tr_24_Template, 1, 0, "tr", 23);
    ɵɵtemplate(25, TableStickyComplexExample_table_34_tr_25_Template, 1, 0, "tr", 23);
    ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r264 = ɵɵnextContext();
    const _r263 = ɵɵreference(24);
    const _r261 = ɵɵreference(8);
    const _r262 = ɵɵreference(16);
...
const _c3$1 = ["header-1"];
const _c4$1 = ["footer-1"];
const _c5$1 = ["position", "symbol"];
/**
...
/** @nocollapse */ TableStickyComplexExample.ngComponentDef = ɵɵdefineComponent({ type: TableStickyComplexExample, selectors: [["table-sticky-complex-example"]], decls: 35, vars: 4, consts: [["mat-raised-button", "", 3, "click"], ["multiple", "", 1, "example-sticky-toggle-group", 3, "value"], ["value", "header-1"], ["value", "header-2"], ["value", "footer-1"], ["value", "footer-2"], ["value", "position"], ["value", "name"], ["value", "weight"], ["value", "symbol"], [1, "example-container", "mat-elevation-z8"], ["mat-table", "", 3, "dataSource", 4, "ngFor", "ngForOf"], ["mat-table", "", 3, "dataSource"], ["matColumnDef", "position", 3, "sticky"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["mat-footer-cell", "", 4, "matFooterCellDef"], ["matColumnDef", "name", 3, "sticky"], ["matColumnDef", "weight", 3, "stickyEnd"], ["matColumnDef", "symbol", 3, "stickyEnd"], ["matColumnDef", "filler"], ["mat-header-row", "", 4, "matHeaderRowDef", "matHeaderRowDefSticky"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-footer-row", "", 4, "matFooterRowDef", "matFooterRowDefSticky"], ["mat-header-cell", ""], ["mat-cell", ""], ["mat-footer-cell", ""], ["mat-header-row", ""], ["mat-row", ""], ["mat-footer-row", ""]], template: function TableStickyComplexExample_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵɵelementStart(5, "div");
        ɵɵtext(6, " Sticky Headers: ");
        ɵɵelementStart(7, "mat-button-toggle-group", 1, _c0$5);
        ɵɵelementStart(9, "mat-button-toggle", 2);
        ɵɵtext(10, " Row 1 ");
        ɵɵelementEnd();
        ɵɵelementStart(11, "mat-button-toggle", 3);
        ...
        ɵɵelementStart(13, "div");
        ɵɵtext(14, " Sticky Footers: ");
        ɵɵelementStart(15, "mat-button-toggle-group", 1, _c1$2);
        ɵɵelementStart(17, "mat-button-toggle", 4);
        ɵɵtext(18, " Row 1 ");
        ɵɵelementEnd();
        ɵɵelementStart(19, "mat-button-toggle", 5);
        ...
        ɵɵelementStart(21, "div");
        ɵɵtext(22, " Sticky Columns: ");
        ɵɵelementStart(23, "mat-button-toggle-group", 1, _c2$1);
        ɵɵelementStart(25, "mat-button-toggle", 6);
        ɵɵtext(26, " Position ");
        ɵɵelementEnd();
        ɵɵelementStart(27, "mat-button-toggle", 7);
        ...
        ɵɵelementEnd();
        ɵɵelementStart(33, "div", 10);
        ɵɵtemplate(34, TableStickyComplexExample_table_34_Template, 26, 14, "table", 11);
        ɵɵelementEnd();
    } if (rf & 2) {
        ɵɵadvance(7);
        ɵɵproperty("value", _c3$1);
        ɵɵadvance(8);
        ɵɵproperty("value", _c4$1);
        ɵɵadvance(8);
        ɵɵproperty("value", _c5$1);
        ɵɵadvance(11);
        ɵɵproperty("ngForOf", ctx.tables);
    } }, directives: [MatButton, MatButtonToggleGroup, MatButtonToggle, NgForOf, MatTable, MatColumnDef, MatHeaderCellDef, MatCellDef, MatFooterCellDef, MatHeaderRowDef, MatRowDef, MatFooterRowDef, MatHeaderCell, MatCell, MatFooterCell, MatHeaderRow, MatRow, MatFooterRow], styles: [".example-container[_ngcontent-%COMP%] {\n  height: 400px;\n  overflow: auto;\n}\n\n.mat-table-sticky[_ngcontent-%COMP%] {\n  background: #59abfd;\n  opacity: 1;\n}\n\n.example-sticky-toggle-group[_ngcontent-%COMP%] {\n  margin: 8px;\n}\n\n.mat-column-filler[_ngcontent-%COMP%] {\n  padding: 0 8px;\n  font-size: 10px;\n  text-align: center;\n}\n\n.mat-header-cell[_ngcontent-%COMP%], .mat-footer-cell[_ngcontent-%COMP%], .mat-cell[_ngcontent-%COMP%] {\n  min-width: 80px;\n  box-sizing: border-box;\n}"] });
...
/** @nocollapse */ TableStickyFooterExample.ngComponentDef = ɵɵdefineComponent({ type: TableStickyFooterExample, selectors: [["table-sticky-footer-example"]], decls: 13, vars: 5, consts: [[1, "example-container", "mat-elevation-z8"], ["mat-table", "", 3, "dataSource"], ["matColumnDef", "item"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["mat-footer-cell", "", 4, "matFooterCellDef"], ["matColumnDef", "cost"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-footer-row", "", 4, "matFooterRowDef", "matFooterRowDefSticky"], ["mat-header-cell", ""], ["mat-cell", ""], ["mat-footer-cell", ""], ["mat-header-row", ""], ["mat-row", ""], ["mat-footer-row", ""]], template: function TableStickyFooterExample_Template(rf, ctx) { if (rf & 1) {
        ɵɵelementStart(0, "div", 0);
        ɵɵelementStart(1, "table", 1);
        ɵɵelementContainerStart(2, 2);
...
/** @nocollapse */ TableTextColumnAdvancedExample.ngFactoryDef = function TableTextColumnAdvancedExample_Factory(t) { return new (t || TableTextColumnAdvancedExample)(); };
/** @nocollapse */ TableTextColumnAdvancedExample.ngComponentDef = ɵɵdefineComponent({ type: TableTextColumnAdvancedExample, selectors: [["table-text-column-advanced-example"]], decls: 7, vars: 5, consts: [["mat-table", "", 1, "mat-elevation-z8", 3, "dataSource"], ["name", "position", 3, "headerText"], ["name", "name", "headerText", "Element"], ["name", "weight", 3, "dataAccessor"], ["name", "symbol", "justify", "end"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-header-row", ""], ["mat-row", ""]], template: function TableTextColumnAdvancedExample_Template(rf, ctx) { if (rf & 1) {
        ɵɵelementStart(0, "table", 0);
...
/** @nocollapse */ TableWrappedExample.ngFactoryDef = function TableWrappedExample_Factory(t) { return new (t || TableWrappedExample)(); };
/** @nocollapse */ TableWrappedExample.ngComponentDef = ɵɵdefineComponent({ type: TableWrappedExample, selectors: [["table-wrapped-example"]], viewQuery: function TableWrappedExample_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵɵelementStart(0, "wrapper-table", 0, _c1$3);
        ɵɵelementContainerStart(2, 1);
        ɵɵtemplate(3, TableWrappedExample_th_3_Template, 2, 0, "th", 2);
        ɵɵtemplate(4, TableWrappedExample_td_4_Template, 2, 1, "td", 3);
        ɵɵelementContainerEnd();
        ɵɵtemplate(5, TableWrappedExample_tr_5_Template, 1, 0, "tr", 4);
        ɵɵtemplate(6, TableWrappedExample_tr_6_Template, 1, 0, "tr", 5);
        ɵɵelementEnd();
    } if (rf & 2) {
...
/** @nocollapse */ WrapperTable.ngFactoryDef = function WrapperTable_Factory(t) { return new (t || WrapperTable)(); };
/** @nocollapse */ WrapperTable.ngComponentDef = ɵɵdefineComponent({ type: WrapperTable, selectors: [["wrapper-table"]], contentQueries: function WrapperTable_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
...
/** @nocollapse */ TableExamplesModule.ngModuleDef = ɵɵdefineNgModule({ type: TableExamplesModule });
/** @nocollapse */ TableExamplesModule.ngInjectorDef = ɵɵdefineInjector({ factory: function TableExamplesModule_Factory(t) { return new (t || TableExamplesModule)(); }, imports: [[
            CommonModule,
            MatButtonModule,
            MatButtonToggleModule,
            MatCheckboxModule,
