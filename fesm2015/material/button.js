...
/** @nocollapse */ ButtonOverviewExample.ngFactoryDef = function ButtonOverviewExample_Factory(t) { return new (t || ButtonOverviewExample)(); };
/** @nocollapse */ ButtonOverviewExample.ngComponentDef = ɵɵdefineComponent({ type: ButtonOverviewExample, selectors: [["button-overview-example"]], decls: 2, vars: 0, consts: [["mat-button", ""]], template: function ButtonOverviewExample_Template(rf, ctx) { if (rf & 1) {
...
/** @nocollapse */ ButtonExamplesModule.ngModuleDef = ɵɵdefineNgModule({ type: ButtonExamplesModule });
/** @nocollapse */ ButtonExamplesModule.ngInjectorDef = ɵɵdefineInjector({ factory: function ButtonExamplesModule_Factory(t) { return new (t || ButtonExamplesModule)(); }, imports: [[
            MatButtonModule,
            MatIconModule,
        ]] });
