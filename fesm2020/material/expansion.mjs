...
ExpansionExamplesModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.0.0-next.1", ngImport: i0, type: ExpansionExamplesModule, declarations: [ExpansionExpandCollapseAllExample,
        ...
        ExpansionOverviewExample,
        ExpansionStepsExample] });
ExpansionExamplesModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.0.0-next.1", ngImport: i0, type: ExpansionExamplesModule, imports: [MatLegacyButtonModule,
        MatDatepickerModule,
        MatNativeDateModule,
        MatExpansionModule,
        MatIconModule,
