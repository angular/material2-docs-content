...
import * as i26 from '@angular/material/legacy-button';
import * as i27 from '@angular/material/legacy-card';
import * as i28 from '@angular/material/datepicker';
import * as i29 from '@angular/material/legacy-input';
...
export declare class DatepickerActionsExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DatepickerActionsExample, "datepicker-actions-example", never, {}, {}, never, never, false>;
}

/** @title Datepicker open method */
export declare class DatepickerApiExample {
    static ɵfac: i0.ɵɵFactoryDeclaration<DatepickerApiExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DatepickerApiExample, "datepicker-api-example", never, {}, {}, never, never, false>;
}

/** @title Datepicker palette colors */
export declare class DatepickerColorExample {
    static ɵfac: i0.ɵɵFactoryDeclaration<DatepickerColorExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DatepickerColorExample, "datepicker-color-example", never, {}, {}, never, never, false>;
}
...
export declare class DatepickerCustomIconExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DatepickerCustomIconExample, "datepicker-custom-icon-example", never, {}, {}, never, never, false>;
}
...
export declare class DatepickerDisabledExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DatepickerDisabledExample, "datepicker-disabled-example", never, {}, {}, never, never, false>;
}
...
export declare class DatepickerFilterExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DatepickerFilterExample, "datepicker-filter-example", never, {}, {}, never, never, false>;
}
...
export declare class DatepickerFormatsExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DatepickerFormatsExample, "datepicker-formats-example", never, {}, {}, never, never, false>;
}
...
export declare class DatepickerHarnessExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DatepickerHarnessExample, "datepicker-harness-example", never, {}, {}, never, never, false>;
}
...
export declare class DatepickerOverviewExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DatepickerOverviewExample, "datepicker-overview-example", never, {}, {}, never, never, false>;
}
...
export declare class DatepickerStartViewExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DatepickerStartViewExample, "datepicker-start-view-example", never, {}, {}, never, never, false>;
}

/** @title Datepicker touch UI */
export declare class DatepickerTouchExample {
    static ɵfac: i0.ɵɵFactoryDeclaration<DatepickerTouchExample, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DatepickerTouchExample, "datepicker-touch-example", never, {}, {}, never, never, false>;
}
...
export declare class DateRangePickerOverviewExample {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DateRangePickerOverviewExample, "date-range-picker-overview-example", never, {}, {}, never, never, false>;
}
