...
import * as i1 from "./slide-toggle-configurable/slide-toggle-configurable-example";
import * as i2 from "./slide-toggle-forms/slide-toggle-forms-example";
import * as i3 from "./slide-toggle-harness/slide-toggle-harness-example";
import * as i4 from "./slide-toggle-overview/slide-toggle-overview-example";
