...
export declare class TableTextColumnExample {
    ...
    static ngFactoryDef: i0.ɵɵFactoryDef<TableTextColumnExample>;
    static ngComponentDef: i0.ɵɵComponentDefWithMeta<TableTextColumnExample, "table-text-column-example", never, {}, {}, never>;
}
