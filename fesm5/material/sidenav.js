...
var SidenavAutosizeExample = /** @class */ (function () {
    ...
    SidenavAutosizeExample.ngComponentDef = ɵɵdefineComponent({ type: SidenavAutosizeExample, selectors: [["sidenav-autosize-example"]], decls: 11, vars: 1, consts: [["autosize", "", 1, "example-container"], ["mode", "side", 1, "example-sidenav"], [4, "ngIf"], ["mat-raised-button", "", 3, "click"], [1, "example-sidenav-content"], ["type", "button", "mat-button", "", 3, "click"]], template: function SidenavAutosizeExample_Template(rf, ctx) { if (rf & 1) {
            ...
            ɵɵelementEnd();
            ɵɵtemplate(5, SidenavAutosizeExample_p_5_Template, 2, 0, "p", 2);
...
var SidenavBackdropExample = /** @class */ (function () {
    ...
    SidenavBackdropExample.ngComponentDef = ɵɵdefineComponent({ type: SidenavBackdropExample, selectors: [["sidenav-backdrop-example"]], decls: 29, vars: 4, consts: [[1, "example-container", 3, "hasBackdrop"], [3, "mode"], ["value", "side"], ["value", "over"], ["value", "push"], [3, "value"], ["mat-raised-button", "", 3, "click"]], template: function SidenavBackdropExample_Template(rf, ctx) { if (rf & 1) {
            ...
            ɵɵelementEnd();
            ɵɵelementStart(8, "mat-select", 2, _c1);
            ...
            ɵɵtext(13, "Over");
            ɵɵelementEnd();
            ɵɵelementStart(14, "mat-option", 4);
            ɵɵtext(15, "Push");
            ɵɵelementEnd();
            ɵɵelementEnd();
            ɵɵelementEnd();
            ...
            ɵɵelementEnd();
            ɵɵelementStart(19, "mat-select", null, _c2);
            ɵɵelementStart(21, "mat-option");
            ɵɵtext(22, "Unset");
            ɵɵelementEnd();
            ɵɵelementStart(23, "mat-option", 5);
            ɵɵtext(24, "True");
            ɵɵelementEnd();
            ɵɵelementStart(25, "mat-option", 5);
            ɵɵtext(26, "False");
            ɵɵelementEnd();
            ɵɵelementEnd();
            ɵɵelementEnd();
...
function SidenavDisableCloseExample_mat_sidenav_container_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementStart(1, "mat-sidenav", 3, _c1$1);
...
var SidenavDisableCloseExample = /** @class */ (function () {
    ...
    SidenavDisableCloseExample.ngComponentDef = ɵɵdefineComponent({ type: SidenavDisableCloseExample, selectors: [["sidenav-disable-close-example"]], viewQuery: function SidenavDisableCloseExample_Query(rf, ctx) { if (rf & 1) {
...
var SidenavDrawerOverviewExample = /** @class */ (function () {
    ...
    SidenavDrawerOverviewExample.ngComponentDef = ɵɵdefineComponent({ type: SidenavDrawerOverviewExample, selectors: [["sidenav-drawer-overview-example"]], decls: 5, vars: 0, consts: [[1, "example-container"], ["mode", "side", "opened", ""]], template: function SidenavDrawerOverviewExample_Template(rf, ctx) { if (rf & 1) {
            ɵɵelementStart(0, "mat-drawer-container", 0);
...
function SidenavFixedExample_ng_container_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementStart(4, "mat-sidenav", 3, _c0$3);
    ɵɵtext(6);
    ɵɵelementEnd();
    ɵɵelementStart(7, "mat-sidenav-content", 4);
    ɵɵelementStart(8, "p");
    ɵɵelementStart(9, "mat-checkbox", 5);
    ɵɵtext(10, "Fixed");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(11, "p");
    ...
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(20, "mat-toolbar", 9);
    ɵɵtext(21, "Footer");
    ɵɵelementEnd();
...
function SidenavModeExample_mat_sidenav_container_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementStart(0, "mat-sidenav-container", 2);
    ɵɵelementStart(1, "mat-sidenav", 3, _c0$4);
    ɵɵelementStart(3, "p");
    ɵɵelementStart(4, "button", 4);
    ...
    ɵɵelementEnd();
    ɵɵelementStart(6, "p");
    ɵɵelementStart(7, "mat-radio-group", 5);
    ɵɵelementStart(8, "label");
    ɵɵtext(9, "Mode:");
    ɵɵelementEnd();
    ɵɵelementStart(10, "mat-radio-button", 6);
    ɵɵtext(11, "Over");
    ɵɵelementEnd();
    ɵɵelementStart(12, "mat-radio-button", 7);
    ɵɵtext(13, "Side");
    ɵɵelementEnd();
    ɵɵelementStart(14, "mat-radio-button", 8);
    ɵɵtext(15, "Push");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
    ...
    ɵɵelementEnd();
    ɵɵelementStart(20, "p");
    ɵɵelementStart(21, "mat-radio-group", 5);
    ɵɵelementStart(22, "label");
    ɵɵtext(23, "Mode:");
    ɵɵelementEnd();
    ɵɵelementStart(24, "mat-radio-button", 6);
    ɵɵtext(25, "Over");
    ɵɵelementEnd();
    ɵɵelementStart(26, "mat-radio-button", 7);
    ɵɵtext(27, "Side");
    ɵɵelementEnd();
    ɵɵelementStart(28, "mat-radio-button", 8);
    ɵɵtext(29, "Push");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
...
function SidenavOpenCloseExample_mat_sidenav_container_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementStart(0, "mat-sidenav-container", 2);
    ɵɵelementStart(1, "mat-sidenav", 3, _c0$5);
    ...
    ɵɵelementStart(5, "p");
    ɵɵelementStart(6, "mat-checkbox", 4);
    ...
    ɵɵtemplate(14, SidenavOpenCloseExample_mat_sidenav_container_0_div_14_Template, 2, 1, "div", 7);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
...
var SidenavOverviewExample = /** @class */ (function () {
    ...
    SidenavOverviewExample.ngComponentDef = ɵɵdefineComponent({ type: SidenavOverviewExample, selectors: [["sidenav-overview-example"]], decls: 2, vars: 2, consts: [["class", "example-container", 4, "ngIf"], [4, "ngIf"], [1, "example-container"], ["mode", "side", "opened", ""]], template: function SidenavOverviewExample_Template(rf, ctx) { if (rf & 1) {
...
function SidenavResponsiveExample_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementStart(8, "mat-sidenav", 7, _c0$6);
    ɵɵelementStart(10, "mat-nav-list");
    ɵɵtemplate(11, SidenavResponsiveExample_div_0_a_11_Template, 2, 1, "a", 8);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementStart(12, "mat-sidenav-content");
    ɵɵtemplate(13, SidenavResponsiveExample_div_0_p_13_Template, 2, 1, "p", 9);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
...
var SidenavExamplesModule = /** @class */ (function () {
    ...
    SidenavExamplesModule.ngModuleDef = ɵɵdefineNgModule({ type: SidenavExamplesModule });
    SidenavExamplesModule.ngInjectorDef = ɵɵdefineInjector({ factory: function SidenavExamplesModule_Factory(t) { return new (t || SidenavExamplesModule)(); }, imports: [[
                CommonModule,
                FormsModule,
                MatButtonModule,
                MatCheckboxModule,
