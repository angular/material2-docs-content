...
function SliderConfigurableExample_mat_checkbox_24_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("ngModelChange", function SliderConfigurableExample_mat_checkbox_24_Template_mat_checkbox_ngModelChange_0_listener($event) { ɵɵrestoreView(_r3); var ctx_r2 = ɵɵnextContext(); return ctx_r2.autoTicks = $event; });
    ɵɵtext(1, " Auto ticks ");
    ɵɵelementEnd();
} if (rf & 2) {
...
function SliderConfigurableExample_mat_form_field_25_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("ngModelChange", function SliderConfigurableExample_mat_form_field_25_Template_input_ngModelChange_3_listener($event) { ɵɵrestoreView(_r5); var ctx_r4 = ɵɵnextContext(); return ctx_r4.tickInterval = $event; });
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
