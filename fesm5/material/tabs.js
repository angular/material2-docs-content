...
var TabGroupAlignExample = /** @class */ (function () {
    ...
    TabGroupAlignExample.ngComponentDef = ɵɵdefineComponent({ type: TabGroupAlignExample, selectors: [["tab-group-align-example"]], decls: 21, vars: 0, consts: [["mat-align-tabs", "start"], ["label", "First"], ["label", "Second"], ["label", "Third"], ["mat-align-tabs", "center"], ["mat-align-tabs", "end"]], template: function TabGroupAlignExample_Template(rf, ctx) { if (rf & 1) {
...
var TabGroupAsyncExample = /** @class */ (function () {
    ...
    TabGroupAsyncExample.ngComponentDef = ɵɵdefineComponent({ type: TabGroupAsyncExample, selectors: [["tab-group-async-example"]], decls: 5, vars: 6, consts: [[4, "ngIf"], [4, "ngFor", "ngForOf"], ["mat-tab-label", ""]], template: function TabGroupAsyncExample_Template(rf, ctx) { if (rf & 1) {
...
var TabGroupBasicExample = /** @class */ (function () {
    ...
    TabGroupBasicExample.ngComponentDef = ɵɵdefineComponent({ type: TabGroupBasicExample, selectors: [["tab-group-basic-example"]], decls: 7, vars: 0, consts: [["label", "First"], ["label", "Second"], ["label", "Third"]], template: function TabGroupBasicExample_Template(rf, ctx) { if (rf & 1) {
...
var TabGroupCustomLabelExample = /** @class */ (function () {
    ...
    TabGroupCustomLabelExample.ngComponentDef = ɵɵdefineComponent({ type: TabGroupCustomLabelExample, selectors: [["tab-group-custom-label-example"]], decls: 10, vars: 0, consts: [["mat-tab-label", ""], [1, "example-tab-icon"]], template: function TabGroupCustomLabelExample_Template(rf, ctx) { if (rf & 1) {
            ɵɵelementStart(0, "mat-tab-group");
...
var TabGroupDynamicHeightExample = /** @class */ (function () {
    ...
    TabGroupDynamicHeightExample.ngComponentDef = ɵɵdefineComponent({ type: TabGroupDynamicHeightExample, selectors: [["tab-group-dynamic-height-example"]], decls: 7, vars: 0, consts: [["dynamicHeight", ""], ["label", "Short tab"], [1, "example-small-box", "mat-elevation-z4"], ["label", "Long tab"], [1, "example-large-box", "mat-elevation-z4"]], template: function TabGroupDynamicHeightExample_Template(rf, ctx) { if (rf & 1) {
            ɵɵelementStart(0, "mat-tab-group", 0);
            ɵɵelementStart(1, "mat-tab", 1);
...
var TabGroupHeaderBelowExample = /** @class */ (function () {
    ...
    TabGroupHeaderBelowExample.ngComponentDef = ɵɵdefineComponent({ type: TabGroupHeaderBelowExample, selectors: [["tab-group-header-below-example"]], decls: 7, vars: 0, consts: [["headerPosition", "below"], ["label", "First"], ["label", "Second"], ["label", "Third"]], template: function TabGroupHeaderBelowExample_Template(rf, ctx) { if (rf & 1) {
            ɵɵelementStart(0, "mat-tab-group", 0);
            ɵɵelementStart(1, "mat-tab", 1);
            ɵɵtext(2, " Content 1 ");
            ɵɵelementEnd();
...
var TabGroupLazyLoadedExample = /** @class */ (function () {
    ...
    TabGroupLazyLoadedExample.ngComponentDef = ɵɵdefineComponent({ type: TabGroupLazyLoadedExample, selectors: [["tab-group-lazy-loaded-example"]], decls: 7, vars: 0, consts: [["label", "First"], ["matTabContent", ""], ["label", "Second"], ["label", "Third"]], template: function TabGroupLazyLoadedExample_Template(rf, ctx) { if (rf & 1) {
            ɵɵelementStart(0, "mat-tab-group");
            ɵɵelementStart(1, "mat-tab", 0);
...
var TabGroupStretchedExample = /** @class */ (function () {
    ...
    TabGroupStretchedExample.ngComponentDef = ɵɵdefineComponent({ type: TabGroupStretchedExample, selectors: [["tab-group-stretched-example"]], decls: 7, vars: 0, consts: [["mat-stretch-tabs", "", 1, "example-stretched-tabs", "mat-elevation-z4"], ["label", "First"], ["label", "Second"], ["label", "Third"]], template: function TabGroupStretchedExample_Template(rf, ctx) { if (rf & 1) {
            ɵɵelementStart(0, "mat-tab-group", 0);
            ɵɵelementStart(1, "mat-tab", 1);
            ɵɵtext(2, " Content 1 ");
            ɵɵelementEnd();
...
var TabGroupExamplesModule = /** @class */ (function () {
    ...
    TabGroupExamplesModule.ngModuleDef = ɵɵdefineNgModule({ type: TabGroupExamplesModule });
    TabGroupExamplesModule.ngInjectorDef = ɵɵdefineInjector({ factory: function TabGroupExamplesModule_Factory(t) { return new (t || TabGroupExamplesModule)(); }, imports: [[
                CommonModule,
                MatButtonModule,
                MatButtonToggleModule,
                MatCheckboxModule,
