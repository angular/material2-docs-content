...
function CustomLinearStepper_button_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementStart(0, "button", 6);
    ɵɵlistener("click", function CustomLinearStepper_button_8_Template_button_click_0_listener() { ɵɵrestoreView(_r9); var i_r7 = ctx.index; var ctx_r8 = ɵɵnextContext(); return ctx_r8.selectStepByIndex(i_r7); });
    ɵɵtext(1);
    ɵɵelementEnd();
} if (rf & 2) {
    var i_r7 = ctx.index;
...
var ɵCustomLinearStepper_BaseFactory = ɵɵgetInheritedFactory(CustomLinearStepper);
